...
def astar_energy_constrained_optimised(G, Dist, Cost, start, goal, budget):
...
if __name__ == "__main__":
    ...
    path, best_distance, best_energy = astar_energy_constrained_optimised(
